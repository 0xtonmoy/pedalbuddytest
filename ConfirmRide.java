...
public class ConfirmRide extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        days.setFilters(new InputFilter[] { new InputFilterMinMax("1", "24") });
    ...
    private void insertData(){
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                c.add(Calendar.HOUR, Integer.parseInt(days.getText().toString()));
...
}}if(isInserted){Toast.makeText(ConfirmRide.this,"Ride Approved",Toast.LENGTH_SHORT).show();ride.setText("Congratulations! Ride Approved. Go to the cycle location, pay the amount and get your ride.");trans.setText("Transaction is updated");}else Toast.makeText(ConfirmRide.this,"Some Error Occurred",Toast.LENGTH_SHORT).show();}});}}