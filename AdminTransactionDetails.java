...
public class AdminTransactionDetails extends AppCompatActivity
    ...
    private void showData() {
        ...
        price_tv.append("BDT. " + price + "/hour");
        ...
        days_tv.setText(Long.toString(hours));
        amt_tv.setText("BDT. " + (Integer.parseInt(price) * hours));
    }
}